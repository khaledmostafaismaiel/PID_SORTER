...
int main(){
    ...
    do{
        ...
        switch(get_process_choise()){
                            ...
                            case 1: strcpy (file_name,"move_forward_kp.txt");
                                    ...
                                    if (pointer_to_file != NULL)
                                    {
                                            if(insertToLinkedList(file_name)){
                                                ...
                                                puts(ANSI_COLOR_BLUE Bold "new node added succesfully"ANSI_COLOR_RESET);
                            ...
                            case 1: strcpy (file_name,"move_forward_kp.txt");
                                    ...
                                    if (pointer_to_file != NULL)
                                    {
                                            if(show_linked_list(move_forward_head_node)){
                                                ...
                                                puts(ANSI_COLOR_BLUE Bold "Linked list showed succesfully"ANSI_COLOR_RESET);
            ...
            case 3:     switch(get_file_name_choise()){
                            ...
                            case 1: strcpy (file_name,"move_forward_kp.txt");
                                    ...
                                    if (pointer_to_file != NULL)
                                    {
                                            if(bubble_sort_linked_list(move_forward_head_node)){
                                            
                                                puts(ANSI_COLOR_BLUE Bold "Linked list sorted succesfully"ANSI_COLOR_RESET);
                            ...
                            case 2: strcpy (file_name,"move_backward_kp.txt");
                                    ...
                                    if (pointer_to_file != NULL)
                                    {
                                            if(bubble_sort_linked_list(move_backward_head_node)){
                            ...
                            case 3: strcpy (file_name,"move_right_side_kp.txt");
                                    ...
                                    if (pointer_to_file != NULL)
                                    {
                                            if(bubble_sort_linked_list(move_right_side_head_node)){
                            ...
                            case 4: strcpy (file_name,"move_left_side_kp.txt");
                                    ...
                                    if (pointer_to_file != NULL)
                                    {
                                            if(bubble_sort_linked_list(move_left_side_head_node)){
                            ...
                            case 5: strcpy (file_name,"move_right_diagonal_up_kp.txt");
                                        ...
                                        if (pointer_to_file != NULL)
                                        {
                                            if(bubble_sort_linked_list(move_right_diagonal_up_head_node)){
                            ...
                            case 6: strcpy (file_name,"move_right_diagonal_down_kp.txt");
                                        ...
                                        if (pointer_to_file != NULL)
                                        {
                                            if(bubble_sort_linked_list(move_right_diagonal_down_head_node)){
                            ...
                            case 7: strcpy (file_name,"move_left_diagonal_up_kp.txt");
                                        ...
                                        if (pointer_to_file != NULL)
                                        {
                                            if(bubble_sort_linked_list(move_left_diagonal_up_head_node)){
                            ...
                            case 8: strcpy (file_name,"move_left_diagonal_down_kp.txt");
                                        ...
                                        if (pointer_to_file != NULL)
                                        {
                                            if(bubble_sort_linked_list(move_left_diagonal_down_head_node)){
